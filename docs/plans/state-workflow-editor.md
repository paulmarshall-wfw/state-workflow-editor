...
- **Workflow Definition**: app-facing action contract that references a state-machine definition and maps named workflow actions onto valid state transitions.
...
- Validate workflow actions against the selected state-machine definition.
...
- State-machine schema remains `0.2.0`; workflow schema starts at `0.1.0`.
